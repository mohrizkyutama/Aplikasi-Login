...
/* Comment : Mmebuat variabel untuk menyimpan informasi email dan password */
const expectedEmail = "mastam@gmail.com";
const expectedPassword = "mastama";
...
loginFormElement.addEventListener("submit", function (event) {
  ...
  */
  ...
  if (email == expectedEmail && password == expectedPassword) {
    ...
    /* Comment: Jika tidak sesuai maka program akan menampilkan pesan PopUp. */
    showPopUp();
  }
});
